...
- ORM Framework가 해결하는 Object–relational impedance mismatch 이 무엇인지 아는만큼 설명해주세요.
...
- JPA N+1 문제가 언제 발생하는지 아는만큼 설명해주세요.
- JPA N+1 문제를 해결하는 방법들을 아는만큼 설명해주세요.
